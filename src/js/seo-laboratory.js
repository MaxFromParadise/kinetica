...
if (document.querySelector('.cases__slider .swiper')) {
	const casesSlider = new Swiper('.cases__slider .swiper', {
		...
		navigation: {
			nextEl: '.cases__nav_next',
			prevEl: '.cases__nav_prev',
		},
		breakpoints: {
			// when window width is >= 992px
			// 1850: {
...
if (document.querySelector('.ai-marquee .swiper')) {
	const aiMarquee = new Swiper('.ai-marquee .swiper', {
		// Optional parameters
		loop: true,
		freeMode: true,
		slidesPerView: 'auto',
...
if (document.querySelector('.our-ais__slider .swiper')) {
	const ourAiMarquee = new Swiper('.our-ais__slider .swiper', {
		// Optional parameters
		loop: true,
		freeMode: true,
		slidesPerView: 'auto',
...
if (document.querySelector('.geoteam .swiper')) {
	const aiMarquee = new Swiper('.geoteam .swiper', {
		// Optional parameters
		loop: false,
		freeMode: true,
		slidesPerView: 'auto',
...
if (document.querySelector('.trust .swiper')) {
	const aiMarquee = new Swiper('.trust .swiper', {
		// Optional parameters
		loop: false,
		freeMode: true,
		slidesPerView: 'auto',
